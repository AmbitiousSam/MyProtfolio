    ...
    <>
      ...
      <div>
        <div ref={about} className="self-flex" id="abt">
          ...
          <h1 ref={abt}>
            <SubElements
              text={portfolioConfig.showcaseBreif}
              element="span"
              class_of_element="fancy-character-abt"
            />
          </h1>
        </div>
      </div>
      ...
      <div ref={about2} className="bit-abt-me-wrapper">
        ...
        <div className="bit-abt-me" ref={abt2}>
          <h1>
            <SubElements
              text={portfolioConfig.aboutYou1}
              element="span"
              class_of_element="fancy-character-abt2"
            />
          </h1>
          <h1>
            <SubElements
              text={portfolioConfig.aboutYou2}
              element="span"
              class_of_element="fancy-character-abt2"
            />
          </h1>
