...
export default function Home() {
  ...
  function HandleSwitch() {
    ...
    if (switchClicked === bgArray.length - 1)
      setSwitchClicked((sw) => (sw = 0));
  }
      ...
      <div className="WRAPPER">
        <nav style={{ backgroundColor: bg }}>
          ...
          <div className="hamburger-menu-button">
            ...
            <p style={{ fontSize: "1.3rem" }} onClick={HandleSwitch}>
              MODES
            </p>
          </div>
        </nav>
            ...
            <div className="fancy-content-wrapper">
              <div>
                <h1 className="fancy-h1">
                  <SubElements
                    text={portfolioConfig.title[0]}
                    element="span"
                    class_of_element="fancy-character"
                  />
                </h1>
                <p onClick={HandleSwitch}>Modes</p>
              </div>
